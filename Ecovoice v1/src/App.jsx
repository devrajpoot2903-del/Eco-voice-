        ...
        <div className="flex-1 flex flex-col bg-cream min-w-0 overflow-hidden w-full">
          ...
          <nav className="lg:hidden shrink-0 flex items-center justify-around border-t border-stone-200 bg-cream px-2 py-2 safe-area-pb">
            ...
            <button
              ...
              className={`flex flex-col items-center gap-0.5 px-4 py-1.5 rounded-xl transition-colors ${isListening ? 'text-forest-700 bg-forest-50' : 'text-stone-500'
                }`}
            ...
            <button
              ...
              className={`flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-xl transition-colors ${activeNav === 'history' ? 'text-forest-700 bg-forest-50' : 'text-stone-500'
                }`}
              aria-label="Activity"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
