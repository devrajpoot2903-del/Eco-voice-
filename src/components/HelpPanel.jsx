    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-stone-100">
          <div>
            <h2 className="text-lg font-semibold text-stone-800">Voice Commands</h2>
            ...
            <div key={group.category}>
              ...
              <ul className="space-y-1 pl-7">
                {group.examples.map((ex) => (
                  <li
                    key={ex}
                    className="text-xs text-stone-500 font-mono bg-stone-50 rounded px-2 py-1 border border-stone-100"
                  >
                    {ex}
                  </li>
                ))}
